 ...
 */
export type ConferenceFixture = Omit<Partial<ConferenceContextValue>, 'call' | 'room' | 'session' | 'actions' | 'slots'> & {
...
export const buildOngoingCallsContext = (value: Partial<OngoingCallsContextValue> = {}): OngoingCallsContextValue => ({
...
export const withOngoingCalls = (value?: Partial<OngoingCallsContextValue>): Decorator => {
...
const LiveOngoingCalls = ({ value, children }: { value: Partial<OngoingCallsContextValue>; children: ReactNode }) => {
	const ringingAt = useLiveRingingAt();
...
export const withLiveOngoingCalls =
	(value: Partial<OngoingCallsContextValue>): Decorator =>
	// eslint-disable-next-line react/display-name
	(Story) => (
