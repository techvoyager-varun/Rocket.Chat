 ...
 *
 * Two things are not the call's to say, and each has its own source. Whether a ring has been quietened comes
 * with the calls; whether *this* client is the one making the noise comes from the video-conf context.
 */
const meta = {
